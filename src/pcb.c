...
extern void banker_release_all(int pid);// note to self :extern is a key word used to declare a function that is defined in another file. in this case, it allows the banker.c file 
